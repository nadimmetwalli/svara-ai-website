      ...
      <footer className="bg-certus-cream text-certus-dark py-16 px-4 relative overflow-hidden">
        ...
        <div className="container mx-auto relative z-10">
            ...
            <div className="flex flex-wrap gap-10 sm:gap-16">
              <div>
                ...
                <div className="space-y-2 text-sm text-certus-dark/70">
                  <a href="#how-it-works" className="block hover:text-certus-dark transition-colors">{t.header.howItWorks}</a>
                  <a href="#roi" className="block hover:text-certus-dark transition-colors">{t.header.roiCalculator}</a>
                </div>
              </div>
              <div>
                <h4 className="text-sm font-semibold text-certus-red mb-4">{t.footer.resources}</h4>
                <div className="space-y-2 text-sm text-certus-dark/70">
                  <a href="#blog" className="block hover:text-certus-dark transition-colors">{t.header.blogs}</a>
                  <Link to="/book-a-demo" className="block hover:text-certus-dark transition-colors">{t.header.bookADemo}</Link>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 pt-6 border-t border-certus-dark/10">
            <p className="text-xs text-foreground/50">{t.footer.copyright}</p>
